...
<style>
/* ... Mantén todo el CSS igual que antes ... */
/* (incluye el CSS del botón respiración, juegos, etc.) */
body {
...
<main id="appContent">
  <section id="registro">
    ...
    <div id="emotions-list">
      ...
      <button class="emotion-btn" data-emotion="Triste" title="Triste">😢<span class="emotion-label">Triste</span></button>
